        ...
        >
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex gap-1.5">
              <a href="#" className="w-8 h-8 rounded-full bg-gray-100 hover:bg-blue-50 flex items-center justify-center transition-colors">
              ...
              <a href="#" className="w-8 h-8 rounded-full bg-gray-100 hover:bg-red-50 flex items-center justify-center transition-colors">
